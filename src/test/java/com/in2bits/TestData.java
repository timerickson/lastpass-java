...
{
    public static final String[] ChunkIds =
        {
    ...
    public static final String BlobBase64 =
    ...
    private static byte[] Decode64(String str) {
        ...
        return Extensions.Strings.decode64(decoder, str);
    }

    public static byte[] Blob = Decode64(BlobBase64);

    public static final byte[] EncryptionKey = Decode64("p8utF7ZB8yD06SrtrD4hsdvEOiBU1Y19cr2dhG9DWZg=");

    public static final byte[] Chunk_PRIK = Decode64(
    ...
    public static final byte[] RsaD = Decode64(
        ...
        "OVgXqw7TM9zIdnZxkVs6yqzJ2FEiXI4KcK7J4iD3rQ==");

    public static final byte[] RsaDP = Decode64(
        "oT8Dc/I+r2VX5xeyVt3VYrC7ExcVxx9tUsFm5b90S1CnfLRMzcOSTXM6z60Q" +
        "bK0w1Q5hmblAViGbJr3twtqwYP7WDrfTOInnE28zXgItrRHCuFltwZmWOXxv" +
        "wHjolcQV51o9gHs08XIV1BdHqHnNLph9qm5hfFJq2HWUn+8poT8=");

    public static final byte[] RsaDQ = Decode64(
        "s6RccDP6SzSFDh63CobUHB5poehNsao5xwg9MLvdOa9PV9DR2qdj4HXvlRrY" +
        "FCuhlafCPgYiTLZBM7COlipR9OneMuNw17YRfI3ROmqVcZLYKhBByZLdzypN" +
        "TGNbcHyMGxj7nu2QJnWyLLCPWe1F7tco0V/bFMBO7Xjk0q0NBB0=");

    public static final byte[] RsaExponent = Decode64("AQAB");

    public static final byte[] RsaInverseQ = Decode64(
        "tFK0dzELJnDl0tj5URPAycY1kXIWa4eMSNXo6KTsGYoCe0ZXjO/zwKKTVlPN" +
        "JJmPZwnXQaN2YtwykrKGikx1ZvdnVfIx+i2FFVdPuGc9LAnmeTbhTC3T0vkK" +
        "L4SqTnCjIpXmSwlV/aPhOOW9EGxK2LSKoD5jreOQatWmpN8Ry18=");

    public static final byte[] RsaModulus = Decode64(
